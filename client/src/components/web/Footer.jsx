            ...
            <div className="row">
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="footer-block first-child">
                  ...
                  At AirFlex, we're passionate about crafting stylish and comfortable footwear for every step of your journey.
                  </p>
                  <ul className="footer-contact">
                    ...
                    <li className="email add">
                      ...
                      <a href="mailto://airflex@gmail.com">
                        airflex@gmail.com
                      </a>
                    </li>
                  </ul>
            ...
            <div className="row">
              <div className="col-lg-6 col-md-6 col-sm-12">
                <div className="copyright">
                  <span>
                    Copyright &copy; 2024 <NavLink to="/">AirFlex.</NavLink> All rights
                    reserved.
                  </span>
                </div>
              </div>
