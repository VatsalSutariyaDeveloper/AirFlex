              ...
              <div className="col-lg-3 order-2 order-lg-1">
                ...
                <div className="widge widge-tags top-rated-tags top-rated-tags-reverse">
                  ...
                  <div className="widge-list widge-tag-list">
                    <ul>
                      <li>
                        <a href="javascript:void(0)">Running Shoes</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Sneakers</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Athletic Shoes</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Loafers</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Wedding Shoes</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Work Shoes</a>
                      </li>
                      <li>
                        <a href="javascript:void(0)">Comfort Shoes</a>
                      </li>
                    </ul>
                  </div>
                </div>
