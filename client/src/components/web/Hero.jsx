  ...
  const testimonials = [
    {
      ...
      content:
        "I absolutely love my new shoes from this company! They are incredibly comfortable and stylish. I can wear them all day without any discomfort. Highly recommend!",
    },
    {
      id: 2,
      name: "David Smith",
      image: "images/testimonial/1.png",
      content:
        "I've been a loyal customer of this shoe brand for years, and I'm always impressed by the quality and durability of their products. Plus, their customer service is top-notch!",
    },
    {
      id: 3,
      ...
      image: "images/testimonial/1.png",
      content:
        "These shoes exceeded my expectations! Not only are they fashionable, but they also provide excellent support for my feet. I've received so many compliments since wearing them.",
    },
  ];
      ...
      <section className="new-product pt-55 pb-100">
        <div className="container">
          <div className="pos-title">
            <h2>new arrivals</h2>
            <p>
              Discover our latest arrivals – where style meets innovation. Step
              into the future of footwear with our latest arrivals and elevate
              your wardrobe with every step.
            </p>
          </div>
      ...
      <section className="featured-pro pt-95">
        <div className="container">
          <div className="pos-title pos-title-2">
            <h2>Products</h2>
            <p>
              Explore our wide range of products, meticulously crafted to meet
              your every need. From stylish sneakers to elegant heels, rugged
              boots to cozy slippers, our collection offers something for
              everyone.
            </p>
          </div>
          <div className="row">
